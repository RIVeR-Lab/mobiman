...
if __name__ == '__main__':
    ...
    rospack1 = RosPack()
    pkg_path = rospack1.get_path('mobiman_simulation')
    ...
    print("[spawn_pedsim_agents::__main__] Waiting for gazebo services...")
    rospy.wait_for_service("gazebo/spawn_sdf_model")
    spawn_model = rospy.ServiceProxy("gazebo/spawn_sdf_model", SpawnModel)
    print("[spawn_pedsim_agents::__main__] service: spawn_sdf_model is available ....")
