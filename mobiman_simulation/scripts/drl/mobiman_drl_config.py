...
class Config():
    ...
    def __init__(self, log_file="", drl_mode="training", flag_print_info=False):        
        ...
        self.reward_step_goal_dist_threshold_m1 = rospy.get_param('reward_step_goal_dist_threshold_m1', 0.0)
        self.reward_step_goal_dist_threshold_m2 = rospy.get_param('reward_step_goal_dist_threshold_m2', 0.0)
        ...
        if self.flag_print_info:
            ...
            print("[mobiman_drl_config::Config::__init__] reward_step_goal_dist_threshold_m1: " + str(self.reward_step_goal_dist_threshold_m1))
            print("[mobiman_drl_config::Config::__init__] reward_step_goal_dist_threshold_m2: " + str(self.reward_step_goal_dist_threshold_m2))
        ...
        if self.log_file:
            ...
            log_data.append(["reward_step_goal_dist_threshold_m1", self.reward_step_goal_dist_threshold_m1])
            log_data.append(["reward_step_goal_dist_threshold_m2", self.reward_step_goal_dist_threshold_m2])
