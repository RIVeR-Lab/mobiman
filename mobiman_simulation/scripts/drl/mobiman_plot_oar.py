...
class PlotMobiman(object):
    ...
    DESCRIPTION: NUA TODO: Update!
    '''
    def plot_rewards_episodic(self, color='red', legend='PPO', plot=True, trim=True, trim_len=14000):
        print("[mobiman_plot_oar::PlotMobiman::plot_rewards] START")
...
if __name__ == '__main__':
    ...
    plot_test_hist_flag = rospy.get_param('plot_test_hist')
    ...
    if isinstance(data_folder, str):
        ...
        if plot_result_flag:
            for i, data in enumerate(data_folder):
                plot_mobiman = PlotMobiman(mobiman_path=mobiman_path,
                                    ...
                                    observation_index=observation_index,
                                    action_index=action_index) # type: ignore
                plot_mobiman.plot_rewards_episodic(plot=False, color=colors[i], legend=data.split('/')[-1])
