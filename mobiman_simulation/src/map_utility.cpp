...
void MapUtility::addMoveitCollisionObjects()
{
  ...
  moveit_collision_objects_.resize(2);

  // Add the first table where the cube will originally be kept.
  moveit_collision_objects_[0].id = "table1";
  moveit_collision_objects_[0].header.frame_id = "virtual_world_link";

  // Define the primitive and its dimensions.
  moveit_collision_objects_[0].primitives.resize(1);
  moveit_collision_objects_[0].primitives[0].type = moveit_collision_objects_[0].primitives[0].BOX;
  moveit_collision_objects_[0].primitives[0].dimensions.resize(3);
  moveit_collision_objects_[0].primitives[0].dimensions[0] = 0.2;
  moveit_collision_objects_[0].primitives[0].dimensions[1] = 1.4;
  moveit_collision_objects_[0].primitives[0].dimensions[2] = 0.4;

  // Define the pose of the table.
  ///*
  moveit_collision_objects_[0].primitive_poses.resize(1);
  moveit_collision_objects_[0].primitive_poses[0].position.x = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].position.y = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].position.z = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].orientation.x = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].orientation.y = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].orientation.z = 0.0;
  moveit_collision_objects_[0].primitive_poses[0].orientation.w = 1.0;
  //*/

  moveit_collision_objects_[0].pose.position.x = 1.0;
  moveit_collision_objects_[0].pose.position.y = 0.0;
  moveit_collision_objects_[0].pose.position.z = 0.2;

  moveit_collision_objects_[0].pose.orientation.x = 0.0;
  moveit_collision_objects_[0].pose.orientation.y = 0.0;
  moveit_collision_objects_[0].pose.orientation.z = 0.0;
  moveit_collision_objects_[0].pose.orientation.w = 1.0;

  moveit_collision_objects_[0].operation = moveit_collision_objects_[0].ADD;

  // Define the object that we will be manipulating
  moveit_collision_objects_[1].header.frame_id = "virtual_world_link";
...
void MapUtility::publishMoveitCollisionObjects()
{
  ...
  for (size_t i = 0; i < moveit_collision_objects_.size(); i++)
  {
    //std::cout << "[MoveitInterface::publishCollisionObjects] ADDED " << i << std::endl;
    moveit_collision_objects_[i].header.stamp = ros::Time::now();
    pub_moveit_collision_object_.publish(moveit_collision_objects_[i]);
  }
